...
Save matplotlib plots as `output_{file_suffix}.png`.

In case using matplotlib, we need to configure config directory before
importing the module. Use appropriate scaling for axes.
